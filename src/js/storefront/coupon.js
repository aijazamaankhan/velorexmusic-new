/* =============================================================================
   ...
   ============================================================================= */
    ...
    const CouponPromo = {
      ...
      async init() {
        // Once per session, and never on top of the intro splash.
        try { if (sessionStorage.getItem(this.KEY)) return; } catch (e) { return; }
      ...
      copy(btn) {
        ...
        const done = () => {
          ...
          if (typeof showToast === 'function') showToast('Code ' + code + ' copied', 'success');
        };
